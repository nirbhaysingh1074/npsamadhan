...
<header>
  <div class="header">
    <div class="container">
      <div class="logo"> <a href="home"><img src="images/logo.png" alt="Logo"></a> 
      
      <div class="last_login"><p>Last Login: May 20, 2015 at 09:39 AM</p></div>
      </div>
      
      <div class="header_right">
        <div class="brnad_logo"><span>Welcome</span> <img src="images/logo_2.png" alt="Logo"></div>
        ...
        <p><span>1. Mr. ABC -</span >+91 9xxxxxxxxx (abc@xxxxx)</p>
         <p><span>2. Mr. DEF -</span> +91 8xxxxxxxxx (def@xxxxxx)</p>
        </div>
      </div>
    </div>
  </div>
