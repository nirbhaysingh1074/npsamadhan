				...
				<form:form method="POST" action="consultantregistration" commandName="regForm">
					...
					<div class="reg-wrap">
						<div>
							...
							<form:input path="consultName" required="required" />
							<span class="error">&nbsp;<form:errors path="consultName"  /></span>
						</div>
					</div>
					<div class="reg-wrap">
						<div>
					...
					<div class="reg-wrap">
						<div>
							...
							<form:input path="founderName" required="required"/>
							<span class="error">&nbsp;<form:errors path="founderName" /></span>
						</div>
					</div>
					<div class="reg-wrap">
						<div>
							<label>Founder Contact</label>
							<form:input path="founderContact" required="required" />
							<span class="error">&nbsp;<form:errors path="founderContact" /></span>
						</div>
					</div>
					...
					<div class="reg-wrap">
						<div>
							...
							<form:input path="yearsInIndusrty" required="required" />
							<span class="error">&nbsp;<form:errors path="yearsInIndusrty" /></span>
						</div>
					</div>
					<div class="reg-wrap">
						<div>
